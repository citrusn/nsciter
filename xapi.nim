...
type
  ISciterAPI* = object
    ...
    SciterDataReadyAsync*: proc (hwnd: HWINDOW; uri: WideCString; data: pointer;
                               dataLength: uint32; requestId: pointer): bool {.stdcall.}
    ...
    SciterSetMasterCSS*: proc (utf8: pointer; numBytes: uint32): bool {.stdcall.}
    SciterAppendMasterCSS*: proc (utf8: pointer; numBytes: uint32): bool {.stdcall.}
    SciterSetCSS*: proc (hWndSciter: HWINDOW; utf8: pointer; numBytes: uint32;
                       baseUrl: WideCString; mediaType: WideCString): bool {.stdcall.}
    SciterSetMediaType*: proc (hWndSciter: HWINDOW; mediaType: WideCString): bool {.stdcall.}
    SciterSetMediaVars*: proc (hWndSciter: HWINDOW; mediaVars: ptr Value): bool {.stdcall.}
    SciterGetMinWidth*: proc (hWndSciter: HWINDOW): uint32 {.stdcall.}
    SciterGetMinHeight*: proc (hWndSciter: HWINDOW; width: uint32): uint32 {.stdcall.}
    ...
    SciterGetPPI*: proc (hWndSciter: HWINDOW; px: ptr uint32; py: ptr uint32) {.stdcall.}
    SciterGetViewExpando*: proc (hwnd: HWINDOW; pval: ptr VALUE): bool {.stdcall.}
    when defined(windows):
    ...
    SciterSetHomeURL*: proc (hWndSciter: HWINDOW; baseUrl: WideCString): bool {.stdcall.}
    when defined(osx):
    ...
    SciterGetFocusElement*: proc (hwnd: HWINDOW; phe: ptr HELEMENT): int32 {.stdcall.}
    SciterFindElement*: proc (hwnd: HWINDOW; pt: Point; phe: ptr HELEMENT): int32 {.stdcall.}
    SciterGetChildrenCount*: proc (he: HELEMENT; count: ptr uint32): int32 {.stdcall.}
    SciterGetNthChild*: proc (he: HELEMENT; n: uint32; phe: ptr HELEMENT): int32 {.stdcall.}
    SciterGetParentElement*: proc (he: HELEMENT; p_parent_he: ptr HELEMENT): int32 {.stdcall.}
    SciterGetElementHtmlCB*: proc (he: HELEMENT; outer: bool;
                                 rcv: LPCBYTE_RECEIVER; rcv_param: pointer): int32 {.stdcall.}
    SciterGetElementTextCB*: proc (he: HELEMENT; rcv: LPCWSTR_RECEIVER;
                                 rcv_param: pointer): int32 {.stdcall.}
    SciterSetElementText*: proc (he: HELEMENT; utf16: WideCString; length: uint32): int32 {.stdcall.}
    SciterGetAttributeCount*: proc (he: HELEMENT; p_count: ptr uint32): int32 {.stdcall.}
    SciterGetNthAttributeNameCB*: proc (he: HELEMENT; n: uint32;
                                      rcv: LPCSTR_RECEIVER; rcv_param: pointer): int32 {.stdcall.}
    ...
    SciterGetAttributeByNameCB*: proc (he: HELEMENT; name: cstring;
                                     rcv: LPCWSTR_RECEIVER; rcv_param: pointer): int32 {.stdcall.}
    SciterSetAttributeByName*: proc (he: HELEMENT; name: cstring; value: WideCString): int32 {.stdcall.}
    SciterClearAttributes*: proc (he: HELEMENT): int32 {.stdcall.}
    SciterGetElementIndex*: proc (he: HELEMENT; p_index: ptr uint32): int32 {.stdcall.}
    SciterGetElementType*: proc (he: HELEMENT; p_type: ptr cstring): int32 {.stdcall.}
    SciterGetElementTypeCB*: proc (he: HELEMENT; rcv: LPCSTR_RECEIVER;
                                 rcv_param: pointer): int32 {.stdcall.}
    SciterGetStyleAttributeCB*: proc (he: HELEMENT; name: cstring;
                                    rcv: LPCWSTR_RECEIVER; rcv_param: pointer): int32 {.stdcall.}
    SciterSetStyleAttribute*: proc (he: HELEMENT; name: cstring; value: WideCString): int32 {.stdcall.}
    SciterGetElementLocation*: proc (he: HELEMENT; p_location: ptr Rect; areas: uint32): int32 {.stdcall.}               
    ## #ELEMENT_AREAS
    SciterScrollToView*: proc (he: HELEMENT; SciterScrollFlags: uint32): int32 {.stdcall.}
    SciterUpdateElement*: proc (he: HELEMENT; andForceRender: bool): int32 {.stdcall.}
    ...
    SciterGetElementHwnd*: proc (he: HELEMENT; p_hwnd: ptr HWINDOW; rootWindow: bool): int32 {.stdcall.}
    ...
    SciterSelectElements*: proc (he: HELEMENT; CSS_selectors: cstring;
                               callback: SciterElementCallback; param: pointer): int32 {.stdcall.}
    ...
    SciterGetElementByUID*: proc (hwnd: HWINDOW; uid: uint32; phe: ptr HELEMENT): int32 {.stdcall.}
    SciterShowPopup*: proc (hePopup: HELEMENT; heAnchor: HELEMENT; placement: uint32): int32 {.stdcall.}
    SciterShowPopupAt*: proc (hePopup: HELEMENT; pos: Point; animate: bool): int32 {.stdcall.}
    SciterHidePopup*: proc (he: HELEMENT): int32 {.stdcall.}
    SciterGetElementState*: proc (he: HELEMENT; pstateBits: ptr uint32): int32 {.stdcall.}
    SciterSetElementState*: proc (he: HELEMENT; stateBitsToSet: uint32;
                                stateBitsToClear: uint32; updateView: bool): int32 {.stdcall.}
    SciterCreateElement*: proc (tagname: cstring; textOrNull: WideCString;
                              phe: ptr HELEMENT): int32 {.stdcall.} ## #out
    SciterCloneElement*: proc (he: HELEMENT; phe: ptr HELEMENT): int32 {.stdcall.} ## #out
    SciterInsertElement*: proc (he: HELEMENT; hparent: HELEMENT; index: uint32): int32 {.stdcall.}
    SciterDetachElement*: proc (he: HELEMENT): int32 {.stdcall.}
    SciterDeleteElement*: proc (he: HELEMENT): int32 {.stdcall.}
    SciterSetTimer*: proc (he: HELEMENT; milliseconds: uint32; timer_id: uint32): int32 {.stdcall.}
    SciterDetachEventHandler*: proc (he: HELEMENT; pep: ElementEventProc; tag: pointer): int32 {.stdcall.}
    SciterAttachEventHandler*: proc (he: HELEMENT; pep: ElementEventProc; tag: pointer): int32 {.stdcall.}
    SciterWindowAttachEventHandler*: proc (hwndLayout: HWINDOW;
        pep: ElementEventProc; tag: pointer; subscription: uint32): int32 {.stdcall.}
    SciterWindowDetachEventHandler*: proc (hwndLayout: HWINDOW;
        pep: ElementEventProc; tag: pointer): int32 {.stdcall.}
    SciterSendEvent*: proc (he: HELEMENT; appEventCode: uint32; heSource: HELEMENT;
                          reason: uint32; handled: ptr bool): int32 {.stdcall.} ## #out
    SciterPostEvent*: proc (he: HELEMENT; appEventCode: uint32; heSource: HELEMENT;
                          reason: uint32): int32 {.stdcall.}
    SciterCallBehaviorMethod*: proc (he: HELEMENT; params: ptr METHOD_PARAMS): int32 {.stdcall.}
    ...
    SciterHttpRequest*: proc (he: HELEMENT; url: WideCString; dataType: uint32;
           requestType: uint32; requestParams: ptr REQUEST_PARAM; nParams: uint32): int32 {.stdcall.}               
    ...
    SciterSetScrollPos*: proc (he: HELEMENT; scrollPos: Point; smooth: bool): int32 {.stdcall.}
    ...
    SciterIsElementVisible*: proc (he: HELEMENT; pVisible: ptr bool): int32 {.stdcall.}
    SciterIsElementEnabled*: proc (he: HELEMENT; pEnabled: ptr bool): int32 {.stdcall.}
    SciterSortElements*: proc (he: HELEMENT; firstIndex: uint32; lastIndex: uint32;
                             cmpFunc: ptr ELEMENT_COMPARATOR; cmpFuncParam: pointer): int32 {.stdcall.}
    ...
    SciterEvalElementScript*: proc (he: HELEMENT; script: WideCString;
                                  scriptLength: uint32; retval: ptr VALUE): int32 {.stdcall.}
    SciterAttachHwndToElement*: proc (he: HELEMENT; hwnd: HWINDOW): int32 {.stdcall.}
    SciterControlGetType*: proc (he: HELEMENT; pType: ptr uint32): int32 {.stdcall.} ## #CTL_TYPE
    SciterGetValue*: proc (he: HELEMENT; pval: ptr VALUE): int32 {.stdcall.}
    SciterSetValue*: proc (he: HELEMENT; pval: ptr VALUE): int32 {.stdcall.}
    SciterGetExpando*: proc (he: HELEMENT; pval: ptr VALUE; forceCreation: bool): int32 {.stdcall.}
    SciterGetObject*: proc (he: HELEMENT; pval: ptr tiscript_value; forceCreation: bool): int32 {.stdcall.}
    SciterGetElementNamespace*: proc (he: HELEMENT; pval: ptr tiscript_value): int32 {.stdcall.}
    SciterGetHighlightedElement*: proc (hwnd: HWINDOW; phe: ptr HELEMENT): int32 {.stdcall.}
    SciterSetHighlightedElement*: proc (hwnd: HWINDOW; he: HELEMENT): int32 {.stdcall.} 
    ## #|
    ## #| DOM Node API
    ## #|
    SciterNodeAddRef*: proc (hn: HNODE): int32 {.stdcall.}
    SciterNodeRelease*: proc (hn: HNODE): int32 {.stdcall.}
    SciterNodeCastFromElement*: proc (he: HELEMENT; phn: ptr HNODE): int32 {.stdcall.}
    SciterNodeCastToElement*: proc (hn: HNODE; he: ptr HELEMENT): int32 {.stdcall.}
    ...
    SciterNodeParent*: proc (hnode: HNODE; pheParent: ptr HELEMENT): int32 {.stdcall.}
    SciterNodeNthChild*: proc (hnode: HNODE; n: uint32; phn: ptr HNODE): int32 {.stdcall.}
    SciterNodeChildrenCount*: proc (hnode: HNODE; pn: ptr uint32): int32 {.stdcall.}
    SciterNodeType*: proc (hnode: HNODE; pNodeType: ptr uint32): int32 {.stdcall.} ## #NODE_TYPE
    SciterNodeGetText*: proc (hnode: HNODE; rcv: LPCWSTR_RECEIVER;
                            rcv_param: pointer): int32 {.stdcall.}
    SciterNodeSetText*: proc (hnode: HNODE; text: WideCString; textLength: uint32): int32 {.stdcall.}
    ...
    ValueType*: proc (pval: ptr VALUE; pType: ptr uint32; pUnits: ptr uint32): uint32 {.stdcall.}
    ...
    ValueInt64DataSet*: proc (pval: ptr VALUE; data: int64; `type`: uint32; units: uint32): uint32 {.stdcall.}
    ...
    ValueFloatDataSet*: proc (pval: ptr VALUE; data: float64; `type`: uint32;
                            units: uint32): uint32 {.stdcall.}
    ValueBinaryData*: proc (pval: ptr VALUE; pBytes: ptr pointer; pnBytes: ptr uint32): uint32 {.stdcall.}
    ...
    ValueNthElementValue*: proc (pval: ptr VALUE; n: int32; pretval: ptr VALUE): uint32 {.stdcall.}
    ValueNthElementValueSet*: proc (pval: ptr VALUE; n: int32; pval_to_set: ptr VALUE): uint32 {.stdcall.}
    ValueNthElementKey*: proc (pval: ptr VALUE; n: int32; pretval: ptr VALUE): uint32 {.stdcall.}
    ValueEnumElements*: proc (pval: ptr VALUE; penum: KeyValueCallback;
                            param: pointer): uint32 {.stdcall.}
    ValueSetValueToKey*: proc (pval: ptr VALUE; pkey: ptr VALUE; pval_to_set: ptr VALUE): uint32 {.stdcall.}
    ValueGetValueOfKey*: proc (pval: ptr VALUE; pkey: ptr VALUE; pretval: ptr VALUE): uint32 {.stdcall.}
    ValueToString*: proc (pval: ptr VALUE; how: uint32): uint32 {.stdcall.} ## #VALUE_STRING_CVT_TYPE
    ...
    ValueNativeFunctorSet*: proc (pval: ptr VALUE;
                                ...
                                prelease: NATIVE_FUNCTOR_RELEASE; tag: pointer): uint32 {.stdcall.}
    ...
    Sciter_V2tv*: proc (vm: HVM; valuev: ptr VALUE; script_value: ptr tiscript_value): bool {.stdcall.}
    SciterOpenArchive*: proc (archiveData: pointer; archiveDataLength: uint32): HSARCHIVE {.stdcall.}
    SciterGetArchiveItem*: proc (harc: HSARCHIVE; path: WideCString;
                               pdata: ptr pointer; pdataLength: ptr uint32): bool {.stdcall.}
    ...
    when defined(windows):
      SciterCreateOnDirectXWindow*: proc (hwnd:HWINDOW, pSwapChain:pointer): bool {.stdcall.}
      SciterRenderOnDirectXWindow*: proc (hwnd:HWINDOW, elementToRenderOrNull:HELEMENT, frontLayer:bool): bool {.stdcall.}
      SciterRenderOnDirectXTexture*: proc (hwnd:HWINDOW, elementToRenderOrNull:HELEMENT, surface:pointer): bool {.stdcall.}
...
proc SciterDataReadyAsync*(hwnd: HWINDOW; uri: WideCString; data: pointer;
                          dataLength: uint32; requestId: pointer): bool #{.inline, discardable, stdcall.} 
  =
  return SAPI().SciterDataReadyAsync(hwnd, uri, data, dataLength, requestId)

when defined(windows):
  proc SciterProc*(hwnd: HWINDOW; msg: uint32; wParam: WPARAM; lParam: LPARAM): LRESULT #{.inline, discardable, stdcall.} 
    =
...
proc SciterLoadFile*(hWndSciter: HWINDOW; filename: WideCString): bool #{.inline, discardable, stdcall.}
  =
...
proc SciterSetCallback*(hWndSciter: HWINDOW; cb: SciterHostCallback; cbParam: pointer) #{.inline, stdcall.} 
  =
...
proc SciterGetMinWidth*(hWndSciter: HWINDOW): uint32 {.inline, discardable, stdcall.} =
...
when defined(windows):
  proc SciterTranslateMessage*(lpMsg: ptr MSG): bool {.inline, discardable, stdcall.} =
    return SAPI().SciterTranslateMessage(lpMsg)

proc SciterSetOption*(hWnd: HWINDOW; option: uint32; value: uint32): bool {.discardable.} =
  return SAPI().SciterSetOption(hWnd, option, value)

proc SciterGetPPI*(hWndSciter: HWINDOW; px: ptr uint32; py: ptr uint32) {.inline, stdcall.} =
...
when defined(osx):
  proc SciterCreateNSView*(frame: ptr Rect): HWINDOW {.inline, discardable, stdcall.} =
...
proc SciterClearAttributes*(he: HELEMENT): int32 {.inline, discardable, stdcall.} =
...
proc SciterReleaseCapture*(he: HELEMENT): int32 {.inline, discardable, stdcall.} =
...
proc SciterSelectParent*(he: HELEMENT; selector: cstring; depth: uint32;
                        heFound: ptr HELEMENT): int32 {.inline, discardable, stdcall.} =
...
proc SciterSetElementHtml*(he: HELEMENT; html: ptr byte; htmlLength: uint32;
                          where: uint32): int32 {.inline, discardable, stdcall.} =
...
proc SciterDetachElement*(he: HELEMENT): int32 {.inline, discardable, stdcall.} =
  return SAPI().SciterDetachElement(he)

proc SciterDeleteElement*(he: HELEMENT): int32 {.inline, discardable, stdcall.} =
...
proc SciterWindowDetachEventHandler*(hwndLayout: HWINDOW; pep: ElementEventProc;
                                    tag: pointer): int32 {.inline, discardable, stdcall.} =
...
proc SciterGetScrollInfo*(he: HELEMENT; scrollPos: ptr Point; viewRect: ptr Rect;
                         contentSize: ptr Size): int32 {.inline, discardable, stdcall.} =
...
proc SciterGetValue*(he: HELEMENT; pval: ptr VALUE): int32 {.inline, discardable, stdcall.} =
  return SAPI().SciterGetValue(he, pval)

proc SciterSetValue*(he: HELEMENT; pval: ptr VALUE): int32 {.inline, discardable, stdcall.} =
...
proc SciterNodeFirstChild*(hn: HNODE; phn: ptr HNODE): int32 {.inline, discardable, stdcall.} =
  return SAPI().SciterNodeFirstChild(hn, phn)

proc SciterNodeLastChild*(hn: HNODE; phn: ptr HNODE): int32 {.inline, discardable, stdcall.} =
...
proc SciterNodeRemove*(hnode: HNODE; finalize: bool): int32 {.inline, discardable, stdcall.} =
...
proc ValueCompare*(pval1: ptr VALUE; pval2: ptr VALUE): uint32 #{.inline, discardable,stdcall.} 
  =
  return SAPI().ValueCompare(pval1, pval2)

proc ValueCopy*(pdst: ptr VALUE; psrc: ptr VALUE): uint32 #{.inline, discardable, stdcall.} =
  = return SAPI().ValueCopy(pdst, psrc)

proc ValueIsolate*(pdst: ptr VALUE): uint32 {.inline, discardable, stdcall.} =
  return SAPI().ValueIsolate(pdst)

proc ValueType*(pval: ptr VALUE; pType: ptr uint32; pUnits: ptr uint32): uint32 #{.inline,discardable, stdcall.} =
  =return SAPI().ValueType(pval, pType, pUnits)

proc ValueStringData*(pval: ptr VALUE; pChars: ptr WideCString; pNumChars: ptr uint32): uint32 #{.inline, discardable, stdcall.} =
...
proc ValueNthElementKey*(pval: ptr VALUE; n: int32; pretval: ptr VALUE): uint32 =
...
proc ValueIsNativeFunctor*(pval: ptr VALUE): bool {.inline, discardable, stdcall.} =
...
proc Sciter_V2tv*(vm: HVM; value: ptr VALUE; out_script_value: ptr tiscript_value): bool {.discardable.} =
  return SAPI().Sciter_V2tv(vm, value, out_script_value)

when defined(windows):
  proc SciterCreateOnDirectXWindow*(hwnd: HWINDOW; pSwapChain: pointer): bool {.discardable.} =
