...
# Integer tests
var field = fieldAddr[]
echo "fieldAddr: " , repr fieldAddr
doAssert field == 0

var objDeref = objAddr[]
echo "objDeref addr " , repr objDeref.addr
...
obj.x = 42
objAddr[].x = 54
echo "objAddr[].x: " , objAddr[].x
echo "objDeref:" , objDeref

doAssert field == 0
echo "obj.x field: ", obj.x, " ", field
doAssert objDeref.x == 0
